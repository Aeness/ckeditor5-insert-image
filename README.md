...
This package implements a feature for inserting image for the open source rich text editors [CKEditor 5](https://ckeditor.com/ckeditor-5/demo/) v29.0.0. It allows the user to insert images with http/https url.
...
```
git clone -b v29.0.0 https://github.com/ckeditor/ckeditor5
