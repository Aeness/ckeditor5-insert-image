...
```
git clone --depth 1 https://github.com/Aeness/ckeditor5-build.git
```
...
```
npm install --save @aeness/ckeditor5-insert-image
```
...
```
npm install --save @ckeditor/ckeditor5-dev-utils @ckeditor/ckeditor5-dev-webpack-plugin @ckeditor/ckeditor5-editor-classic @ckeditor/ckeditor5-essentials @ckeditor/ckeditor5-paragraph @ckeditor/ckeditor5-theme-lark
```
